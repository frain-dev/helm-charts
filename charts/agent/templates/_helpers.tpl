...
Common labels
*/}}
{{- define "convoy-agent.labels" -}}
helm.sh/chart: {{ include "convoy-agent.chart" . }}
{{ include "convoy-agent.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "convoy-agent.selectorLabels" -}}
...
*/}}
{{- define "convoy-agent.queueProviderEnv" -}}
...
{{- fail "global.convoy.queue_provider is \"postgres\" but agent.env.enable_feature_flag does not include \"postgres-queue\". Convoy refuses to boot with the Postgres queue unless that feature flag is set, and the provider also needs a paid license that includes it. Set the flag on the server too." -}}
{{- end -}}
{{- end -}}
