...
| global.externalDatabase.secret.enabled          | string | `"false"`                                               | get username and password from secret, assumes keys are "CONVOY_DB_USERNAME", "CONVOY_DB_PASSWORD"       |
| global.externalDatabase.secret.name             | string | `"convoy"`                                              | secret name                                                                                              |
...
| global.externalRedis.secret.enabled          | string | `"false"`                                               | get username and password from secret, assumes keys are "CONVOY_REDIS_USERNAME", "CONVOY_REDIS_PASSWORD" |
| global.externalRedis.secret.name             | string | `"convoy"`                                              | secret name                                                                                              |
